...
pub struct NewBlockEventAggregation {
    vote_window_size: usize,
    proposer_window_size: usize,
}

impl NewBlockEventAggregation {
    pub fn new(vote_window_size: usize, proposer_window_size: usize) -> Self {
        Self {
            vote_window_size,
    ...
    pub fn count_votes(
        ...
        Self::history_iter(history, epoch, self.vote_window_size).fold(
            HashMap::new(),
            |mut map, meta| {
    ...
    pub fn count_proposals(&self, epoch: u64, history: &[NewBlockEvent]) -> HashMap<Author, i32> {
...
impl ReputationHeuristic for ActiveInactiveHeuristic {
    fn get_weights(
        ...
        LEADER_REPUTATION_WINDOW_SIZE.set(proposals.values().sum::<i32>() as i64);
...
impl ProposerAndVoterHeuristic {
    pub fn new(
        ...
        Self {
            ...
            aggregation: NewBlockEventAggregation::new(vote_window_size, proposer_window_size),
        }
    }
}
